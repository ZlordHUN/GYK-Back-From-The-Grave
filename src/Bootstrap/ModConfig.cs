...
namespace GraveyardKeeperCoop
{
    public class ModConfig
    {
        ...
        public static ConfigEntry<string> TestFixtureId;
        ...
        public ConfigEntry<int> PlayerPantsTone;
        public ConfigEntry<int> PlayerShirtTone;
        public ConfigEntry<int> PlayerHairTone;
        public ConfigEntry<int> PlayerSkinShade;
        public ConfigEntry<int> PlayerEyeTone;
        public ConfigEntry<string> PlayerRecentCosmeticColors;
        public ConfigEntry<string> PlayerCosmeticPresets;
        ...
        public static void InitConfig(ConfigFile config)
        {
            ...
            TestFixtureId = config.Bind("Debug",
                "TestFixtureId",
                "manual",
                "Testing label written to every multiplayer session log. Use the installed fixture ID, or leave as 'manual' for ordinary play.");
            ...
            OverrideFramePacing = config.Bind("Performance",
                "OverrideFramePacing",
                false,
                "Use the mod's FPS limit instead of the game's default frame pacing. This is controlled by the FPS limit row in Options.");

            TargetFrameRate = config.Bind("Performance",
                "TargetFrameRate",
                60,
                "FPS cap selected in the game's Options menu when OverrideFramePacing is enabled.");
            ...
            EnableCheats = config.Bind("Cheats",
                "EnableCheats",
                false,
                "Enable debug commands (/give, /spawn, /time, /tp, /weather, /test) for all players in multiplayer.");
            ...
            Instance.PlayerPantsTone = config.Bind("Cosmetics",
                "PantsTone",
                PlayerCosmetics.DEFAULT_TONE,
                "Pants saturation/brightness index (0-7)");

            Instance.PlayerShirtTone = config.Bind("Cosmetics",
                "ShirtTone",
                PlayerCosmetics.DEFAULT_TONE,
                "Shirt saturation/brightness index (0-7)");

            Instance.PlayerHairTone = config.Bind("Cosmetics",
                "HairTone",
                PlayerCosmetics.DEFAULT_TONE,
                "Hair saturation/brightness index (0-7)");

            Instance.PlayerSkinShade = config.Bind("Cosmetics",
                "SkinShade",
                PlayerCosmetics.DEFAULT_TONE,
                "Skin saturation/brightness index (0-7)");

            Instance.PlayerEyeTone = config.Bind("Cosmetics",
                "EyeTone",
                PlayerCosmetics.DEFAULT_TONE,
                "Eye saturation/brightness index (0-7)");

            Instance.PlayerRecentCosmeticColors = config.Bind("Cosmetics",
                "RecentColors",
                "",
                "Recently applied hue/tone selections per wardrobe category");

            Instance.PlayerCosmeticPresets = config.Bind("Cosmetics",
                "SavedPresets",
                "",
                "Recently applied complete wardrobe appearances");
        }
    }
}
