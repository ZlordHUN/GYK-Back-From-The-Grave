...
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_LOADER_VERSION)]
    public class CoopMod : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            SessionLogContext.InitializeProcess();
            StoryCatalogRuntime.Initialize();
        ...
        private void InitializeOnlineCoop()
        {
            ...
            CreatePersistentComponent<Multiplayer.FishingPresentationSync>("FishingPresentationSync");
