...
namespace GraveyardKeeperCoop.UI
{
    ...
    public class SaveSelectorPanel : MonoBehaviour
    {
        ...
        public void Initialize(Transform parent, Vector3 localPosition, GameObject saveSlotTemplate)
        {
            ...
            if (saveSlotsMenuGUI != null)
            {
                ...
                slotsTable = menuClone.GetComponentInChildren<UITable>(true);
                ...
                if (slotsTable != null)
                {
                    ...
                    CoopMod.Logger.LogInfo("Found UITable for save slots");
        ...
        private void CreateScrollView()
        {
            ...
            slotsTable = slotsContainer.AddComponent<UITable>();
            slotsTable.columns = 1;
            slotsTable.padding = new Vector2(0, 10);
            slotsTable.pivot = UIWidget.Pivot.Top;
        ...
        {
            // In the multiplayer lobby, only show coop saves
        ...
        private void CreateSlotItem(SaveSlotData slotData)
        {
            ...
            // Add click handler
            AddClickHandler(slotObj, slotData, deleteButtonObject);
        ...
        private void AddClickHandler(GameObject slotObj, SaveSlotData slotData, GameObject deleteButton)
        {
            // Add a component to handle clicks
            var clickHandler = slotObj.AddComponent<SaveSlotClickHandler>();
            clickHandler.Initialize(slotData, () => OnSlotClicked(slotData), deleteButton);
        }
        ...
        private void UpdateSlotHighlights()
        {
            ...
            foreach (var slotObj in slotItems)
            {
                ...
                // Find the gamepad_frame widget and activate/deactivate it
                var widgets = slotObj.GetComponentsInChildren<UIWidget>(true);
                foreach (var widget in widgets)
                {
                    if (widget.name.ToLower().Contains("gamepad_frame") || widget.name.ToLower().Contains("frame"))
                    {
                        widget.gameObject.SetActive(isSelected);
                    }
                }
            }
        }
    ...
    public class SaveSlotClickHandler : MonoBehaviour
    {
        ...
        public void Initialize(SaveSlotData data, System.Action clickCallback, GameObject deleteButton = null)
        {
            slotData = data;
