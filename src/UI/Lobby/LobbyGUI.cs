...
namespace GraveyardKeeperCoop.UI
{
    ...
    public class LobbyGUI : BaseMenuGUI
    {
        ...
        private GameObject keepersButtonObj; // Entry point for lobby keeper selection
        ...
        private UIWidget keepersButtonWidget;
        ...
        private GamepadNavigationItem keepersNavigationItem;
        ...
        private static readonly LobbyResolutionLayout DefaultResolutionLayout = new LobbyResolutionLayout(
            ...
            10,
            45,
            new Vector3(80f, -165f, 0f),
            new Vector3(250f, -220f, 0f),
            220,
            35,
            210,
            30,
            new Vector3(-200f, -220f, 0f),
            new Vector3(0f, -220f, 0f),
            new Vector3(-55f, 100f, 0f),
            new Vector3(55f, 100f, 0f));
        private static LobbyResolutionLayout CreateCompactResolutionLayout(
            string name,
            int width,
            int height,
            float rootScale,
            float rootYOffset = 0f)
        {
            ...
            return new LobbyResolutionLayout(
                name,
                width,
                height,
                new Vector3(0f, rootYOffset, 0f),
                new Vector3(rootScale, rootScale, 1f),
                new Vector3(0f, 140f + yOffset, 0f),
                new Vector3(-columnX, 60f + yOffset, 0f),
                new Vector3(-columnX, 15f + yOffset, 0f),
                Vector3.one,
                new Vector3(-columnX - 80f, 15f + yOffset, 0f),
                new Vector3(-columnX, -98f + yOffset, 0f),
                new Vector3(0.90f, 0.90f, 1f),
                new Vector3(columnX, 60f + yOffset, 0f),
                new Vector3(columnX, 30f + yOffset, 0f),
                Vector3.one,
                180,
                new Vector3(columnX - 100f, 30f + yOffset, 0f),
                435f,
                180f,
                -10f,
                -90f,
                ...
                9,
                45,
                new Vector3(columnX - 120f, -157f + yOffset, 0f),
                new Vector3(columnX + 50f, -202f, 0f),
                220,
                35,
                210,
                30,
                new Vector3(-columnX, -202f, 0f),
                new Vector3(0f, -202f, 0f),
                new Vector3(-55f, 100f + yOffset, 0f),
                new Vector3(55f, 100f + yOffset, 0f));
        }

        private static LobbyResolutionLayout CreateFullHeightResolutionLayout(
            string name,
            int width,
            int height,
            float rootScale,
            float columnX = 200f)
        {
            return new LobbyResolutionLayout(
                ...
                new Vector3(-columnX, 82f, 0f),
                new Vector3(-columnX, 37f, 0f),
                Vector3.one,
                new Vector3(-columnX - 80f, 37f, 0f),
                new Vector3(-columnX, -76f, 0f),
                new Vector3(0.90f, 0.90f, 1f),
                new Vector3(columnX, 82f, 0f),
                new Vector3(columnX, 58f, 0f),
                Vector3.one,
                200,
                new Vector3(columnX - 100f, 37f, 0f),
                435f,
                185f,
                -10f,
                -92.5f,
                ...
                10,
                45,
                new Vector3(columnX - 120f, -143f, 0f),
                new Vector3(columnX + 50f, -198f, 0f),
                220,
                35,
                210,
                30,
                new Vector3(-columnX, -198f, 0f),
                new Vector3(0f, -198f, 0f),
                new Vector3(-55f, 126f, 0f),
                new Vector3(55f, 126f, 0f));
        }

        private static readonly LobbyResolutionLayout[] ResolutionLayouts =
        {
            CreateCompactResolutionLayout("SteamDeck1280x800", 1280, 800, 0.94f, 12f),
            CreateCompactResolutionLayout("1366x768", 1366, 768, 0.90f, 12f),
            CreateCompactResolutionLayout("1440x900", 1440, 900, 0.94f),
            CreateCompactResolutionLayout("1600x900", 1600, 900, 0.94f),
            CreateCompactResolutionLayout("1920x800", 1920, 800, 0.90f),
            CreateFullHeightResolutionLayout("1920x1080", 1920, 1080, 1.00f),
            CreateFullHeightResolutionLayout("1920x1200", 1920, 1200, 1.00f),
            CreateFullHeightResolutionLayout("1920x1280", 1920, 1280, 1.00f),
            CreateFullHeightResolutionLayout("1920x1440", 1920, 1440, 1.00f),
            CreateFullHeightResolutionLayout("2048x1152", 2048, 1152, 1.00f),
            CreateFullHeightResolutionLayout("2048x1536", 2048, 1536, 1.00f),
            CreateFullHeightResolutionLayout("2560x1080", 2560, 1080, 1.00f),
            CreateFullHeightResolutionLayout("1600x1200", 1600, 1200, 0.94f, 160f),
            CreateFullHeightResolutionLayout("1680x1050", 1680, 1050, 0.94f, 160f),
            CreateFullHeightResolutionLayout("1440x960", 1440, 960, 0.94f, 160f),
            CreateFullHeightResolutionLayout("1440x1080", 1440, 1080, 0.94f, 160f),
            CreateFullHeightResolutionLayout("1280x960", 1280, 960, 0.94f, 160f),
            CreateFullHeightResolutionLayout("1280x1024", 1280, 1024, 0.94f, 160f),
            CreateFullHeightResolutionLayout("1400x1050", 1400, 1050, 0.94f, 160f)
        };
        ...
        private sealed class LobbyResolutionLayout
        {
            ...
            public readonly Vector3 KeepersButtonPosition;
                ...
                Vector3 inviteButtonPosition)
            {
                ...
                KeepersButtonPosition = keepersButtonPosition;
        ...
        private void ApplyResolutionLayout()
        {
            ...
            {
                CoopMod.Logger.LogInfo($"[LobbyGUI] Applying default layout for {Screen.width}x{Screen.height}");
            }

            transform.localPosition = layout.RootPosition;
            transform.localScale = layout.RootScale;

            // Resizing an anchored NGUI widget can move its transform. Apply the
            // dimensions first, then set the final position below.
            ...
            ApplyTransform(
                chatBackgroundObj,
                layout.ChatBackgroundPosition,
                layout.ChatBackgroundScale);
            RefreshWidgetAnchors(chatBackgroundObj);
            ...
            ApplyTransform(keepersButtonObj, layout.KeepersButtonPosition, Vector3.one);
            ...
            CoopMod.Logger.LogInfo(
                ...
                $"chatBackground={layout.ChatBackgroundPosition}/h{layout.ChatBackgroundHeight}, " +
                $"chatInput={layout.ChatInputPosition}, send={layout.SendButtonPosition}");
        ...
        {
            // BaseMenuGUI and NGUI can run table, anchor, and pixel-perfect
            // updates late in the frame while a changed resolution settles.
            // Resume after LateUpdate so our owned layout is the final writer.
        ...
        private static void ApplyWidgetHeight(GameObject target, int height)
        {
            ...
            // The cloned SaveSlotGUI background carries external anchors and,
            // on some resolution transitions, restores its old height on the
            // first active frame. This lobby owns the widget geometry.
            ...
            UIStretch stretch = target.GetComponent<UIStretch>();
            if (stretch != null)
        ...
        private static void RefreshWidgetAnchors(GameObject target)
        {
            if (target == null)
                return;

            // The visible SaveSlot frame is composed of child widgets anchored
            // to the resized root. Updating only the root leaves those children
            // at the previous resolution's height until the GUI is reopened.
        ...
        private void CreateButtons(Transform parent)
        {
            ...
            // Lobby commands sit together beneath the title, independent of the columns.
            GameObject keepersObj = Object.Instantiate(template, parent);
            keepersObj.name = "btn_keepers";
            keepersObj.transform.localPosition = new Vector3(-55f, 100f, 0f);
            keepersObj.transform.localScale = Vector3.one;
            keepersObj.layer = 13;

            var keepersLabel = keepersObj.GetComponentInChildren<UILabel>(true);
            if (keepersLabel != null)
                keepersLabel.text = "Keepers";

            var keepersButtonGUI = keepersObj.GetComponent<DialogButtonGUI>();
            if (keepersButtonGUI != null)
                Object.Destroy(keepersButtonGUI);

            foreach (var btn in keepersObj.GetComponentsInChildren<UIButton>(true))
                Object.Destroy(btn);

            keepersButtonWidget = keepersObj.GetComponent<UIWidget>() ??
                                  keepersObj.GetComponentInChildren<UIWidget>(true);
            keepersButtonObj = keepersObj;

            // Create Invite button beside Keepers.
            GameObject inviteObj = Object.Instantiate(template, parent);
            inviteObj.name = "btn_invite";
            inviteObj.transform.localPosition = new Vector3(55f, 100f, 0f);
            ...
            keepersNavigationItem = ConfigureControllerButton(keepersButtonObj, OnKeepersPressed);
            inviteNavigationItem = ConfigureControllerButton(inviteButtonObj, OnInvitePressed);
            CoopMod.Logger.LogInfo($"Created Keepers button at {keepersObj.transform.localPosition}, widget: {keepersButtonWidget != null}");
        ...
        {
            if (backNavigationItem == null || startNavigationItem == null ||
                keepersNavigationItem == null || inviteNavigationItem == null)
                return;
            ...
            for (int i = 0; i < slots.Length; i++)
            {
                ...
                slot.active = true;
                slot.SetCustomDirectionItem(i > 0 ? slots[i - 1] : keepersNavigationItem, Direction.Up);
            ...
            keepersNavigationItem.active = true;
            keepersNavigationItem.SetCustomDirectionItem(firstSlot ?? backNavigationItem, Direction.Down);
            keepersNavigationItem.SetCustomDirectionItem(inviteNavigationItem, Direction.Right);

            inviteNavigationItem.active = true;
            inviteNavigationItem.SetCustomDirectionItem(firstSlot ?? startNavigationItem, Direction.Down);
            inviteNavigationItem.SetCustomDirectionItem(keepersNavigationItem, Direction.Left);
            inviteNavigationItem.SetCustomDirectionItem(startNavigationItem, Direction.Right);

            backNavigationItem.active = true;
            backNavigationItem.SetCustomDirectionItem(lastSlot ?? keepersNavigationItem, Direction.Up);
        ...
        private new void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0) && uiCamera != null)
            {
                ...
                // Check Keepers button click
                if (keepersButtonWidget != null)
                {
                    Vector3[] corners = keepersButtonWidget.worldCorners;
                    Vector2 min = uiCamera.WorldToScreenPoint(corners[0]);
                    Vector2 max = uiCamera.WorldToScreenPoint(corners[2]);
                    ...
                    if (mousePos.x >= minX && mousePos.x <= maxX &&
                        mousePos.y >= minY && mousePos.y <= maxY)
                    {
                        CoopMod.Logger.LogInfo("Keepers button clicked!");
                        OnKeepersPressed();
                        return;
                    }
                }
        ...
        private void OnGameStartReceived(CSteamID hostID, string saveSlotName)
        {
            ...
            CharacterCustomizationGUI.Instance?.CloseForLobbyTransition();
        ...
        private void OnKeepersPressed()
        {
            CoopMod.Logger.LogInfo("[UI] Keepers lobby command pressed");

            Hide(false);
            CharacterCustomizationGUI editor = CharacterCustomizationGUI.Instance ??
                                                CharacterCustomizationGUI.Create();
            if (editor != null && editor.OpenFromLobby())
                return;

            CoopMod.Logger.LogError(
                "[UI] Failed to open the lobby keeper editor; restoring the lobby");
            ShowChatInput();
        }
