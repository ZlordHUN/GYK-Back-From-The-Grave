...
namespace GraveyardKeeperCoop.UI
{
    ...
    public class ChatPanel : MonoBehaviour
    {
        ...
        private float overflowTopFadeOffset;
        private int scrollLineOffset;
        private int renderedVisibleLineCapacity = 10;
        private const float CLIP_BOTTOM_PADDING = 6f;
        ...
        public void ApplyLayout(
            ...
            float overflowTopFadeOffset = 0f)
        {
            transform.localPosition = localPosition;
            ...
            this.overflowTopFadeOffset = Mathf.Max(0f, overflowTopFadeOffset);
        ...
        private void UpdateDisplay(bool scrollToBottom = false)
        {
            ...
            float maximumTopY = contentTopY + overflowTopFadeOffset;
