...
namespace GraveyardKeeperCoop.UI
{
    ...
    public class FriendInviteGUI : BaseMenuGUI
    {
        ...
        {
            new FriendInviteResolutionLayout(
                "SteamDeck1280x800",
                1280,
                800,
                ...
                new Vector3(-150f, 70f, 0f),
                new Vector3(-180f, -230f, 0f),
            ...
            new FriendInviteResolutionLayout(
                ...
                new Vector2(10f, 10f),
                new Vector3(0.74f, 0.74f, 1f),
                new Vector3(-160f, 70f, 0f),
                new Vector3(-200f, -225f, 0f),
            ...
            new FriendInviteResolutionLayout(
                ...
                new Vector2(10f, 10f),
                new Vector3(0.78f, 0.78f, 1f),
                new Vector3(-170f, 70f, 0f),
                new Vector3(-220f, -230f, 0f),
                new Vector3(0f, -230f, 0f),
                new Vector3(220f, -230f, 0f)),
            new FriendInviteResolutionLayout(
                "1920x800",
                ...
                new Vector2(10f, 10f),
                new Vector3(0.74f, 0.74f, 1f),
                new Vector3(-190f, 70f, 0f),
                new Vector3(-260f, -225f, 0f),
                new Vector3(0f, -225f, 0f),
                new Vector3(260f, -225f, 0f)),
            new FriendInviteResolutionLayout(
                "1920x1080",
            ...
            new FriendInviteResolutionLayout(
                ...
                new Vector2(10f, 10f),
                new Vector3(0.78f, 0.78f, 1f),
                new Vector3(-180f, 70f, 0f),
                new Vector3(-235f, -230f, 0f),
                new Vector3(0f, -230f, 0f),
                new Vector3(235f, -230f, 0f)),
            new FriendInviteResolutionLayout(
                "1440x960",
        ...
        private void ApplyResolutionLayout()
        {
            ...
            {
                CoopMod.Logger.LogInfo($"[FriendInviteGUI] Using default unscaled layout for {Screen.width}x{Screen.height}");
                return;
            }
