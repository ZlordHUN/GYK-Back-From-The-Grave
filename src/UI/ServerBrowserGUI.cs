...
namespace GraveyardKeeperCoop.UI
{
    ...
    public class ServerBrowserGUI : MonoBehaviour
    {
        ...
        public void ApplyResolutionLayout()
        {
            ...
            transform.localScale = activeLayout.LocalScale;
            ...
            {
                tabBarContainer.transform.localScale = activeLayout.StyledTabContainerScale;
            }
        ...
        private static string BuildLanSnapshotFingerprint(List<LanServerInfo> lanServers)
        {
            ...
            {
                parts.Add($"{server.LobbyID.m_SteamID}:{server.HostSteamID.m_SteamID}:{server.CurrentPlayers}:{server.MaxPlayers}:{server.Status}:{server.Endpoint}:{server.DLCRequirements}");
            }
