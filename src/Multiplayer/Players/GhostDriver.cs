...
namespace GraveyardKeeperCoop.Multiplayer
{
    ...
    public class GhostDriver : MonoBehaviour
    {
        ...
        // Movement packets carry Transform coordinates/velocities. Graveyard Keeper's
        // movement speed is expressed in game units and multiplied by 96 before MovePosition.
        private const float WORLD_UNITS_PER_GAME_UNIT = 96f;
        private const float SNAP_DIST = 6f * WORLD_UNITS_PER_GAME_UNIT;
        ...
        private const float MAX_WALK_SPEED = 5f * WORLD_UNITS_PER_GAME_UNIT;
