...
namespace GraveyardKeeperCoop.Multiplayer
{
    public class PlayerParamSync : PeriodicSyncBehaviour
    {
        ...
        private static bool IsLocalOnlyParam(string key)
        {
            return LocalOnlyParams.Contains(key) ||
                   QuestSideEffectSync.IsPersonalGrantReceipt(key);
        }
