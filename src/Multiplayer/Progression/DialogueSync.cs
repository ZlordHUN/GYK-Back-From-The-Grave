...
namespace GraveyardKeeperCoop.Multiplayer
{
    ...
    public class DialogueSync : SyncBehaviour
    {
        ...
        private void HandleRemoteDialogueEnd(CSteamID senderID)
        {
            ...
            else if (Patches.NpcInteractionSyncPatches
                         .IsObservedNpcInteractionParticipating(senderID))
            {
            ...
            {
                CoopMod.Logger.LogInfo(
                    $"{LogPrefix} Remote dialogue ended without a matching " +
                    "presentation lock; preserving local control state");
            }
        }
