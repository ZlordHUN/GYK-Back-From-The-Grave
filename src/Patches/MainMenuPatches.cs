...
namespace GraveyardKeeperCoop.Patches
{
    ...
    public class MainMenuPatches
    {
        ...
        public static bool IsMultiplayerSave(SaveSlotData slot)
        {
            ...
            if (slot.filename_no_extension != null && slot.filename_no_extension.StartsWith("coop_"))
                return true;
            // Fallback: check for coop_positions sidecar
            string sidecarPath = UnityEngine.Application.persistentDataPath + "/" + slot.filename_no_extension + ".coop_positions.json";
        ...
        public static void Init_Postfix(MainMenuGUI __instance)
        {
            ...
            try
            {
                ...
                // GYK-style ChatOverlay (src/UI/ChatOverlay.cs), which is created by
